...
#if (DBG_SYSTEM_EN)
  EventRecorderDisable(EventRecordAll, EvtNetSYS, EvtNetLOOP);
...
#endif
#if (DBG_CORE4_EN)
  EventRecorderDisable(EventRecordAll, EvtNetIP4, EvtNetARP);
...
#endif
#if (DBG_CORE6_EN)
  EventRecorderDisable(EventRecordAll, EvtNetIP6, EvtNetNDP);
...
#endif
#if (DBG_SOCKET_EN)
  EventRecorderDisable(EventRecordAll,EvtNetUDP, EvtNetBSD);
...
#endif
#if (DBG_SERVICE_EN)
  EventRecorderDisable(EventRecordAll,EvtNetHTTPs,EvtNetSNTP);
