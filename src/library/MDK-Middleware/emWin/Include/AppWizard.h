...
//--------------------------------------------------------------------------------
  ...
  /* 34 */ APPW_SET_PROP_TEXTID2    ,  // pSetup->aPara [0].p     = Pointer to pointer containing Id-string
                                       // pSetup->aPara [0].v     = Index value of text calculated in APP_DataUpdateObjects()
  /* 35 */ APPW_SET_PROP_ALIGN      ,  // pSetup->aPara [0].v     = pObj->Align
  /* 36 */ APPW_SET_PROP_RADIUS     ,  // pSetup->aPara [0].v     = Radius
  /* 37 */ APPW_SET_PROP_FRAME      ,  // pSetup->aPara [0].v     = Frame
  /* 38 */ APPW_SET_PROP_BORDER     ,  // pSetup->aPara [0].v     = Border
  /* 39 */ APPW_SET_PROP_LENGTH     ,  // pSetup->aPara [0].v     = Length
  /* 40 */ APPW_SET_PROP_ROTATION      // pSetup->aPara [0].p     = Pointer to GUI_ROTATION structure
};
...
void                    APPW_SetDefaultPosition      (WM_HWIN hWin);
