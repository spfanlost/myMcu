 ...
 */
  ...
  __STATIC_INLINE void EvrNetMEM_InitMemory(uint32_t pool_size, uint32_t limit0, uint32_t limit1) {
    EventRecord4 (EvtNetMEM_InitMemory, pool_size, limit0, limit1, 0);
  }
#else
  #define EvrNetMEM_InitMemory(pool_size, limit0, limit1)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetMEM_AllocMemory(uint32_t size, uint32_t used, uint32_t blocks) {
    EventRecord4 (EvtNetMEM_AllocMemory, size, used, blocks, 0);
  }
#else
  #define EvrNetMEM_AllocMemory(size, used, blocks)
#endif
...
/**
  ...
  \param  old_size      current block size
 */
#ifdef DEBUG_EVR
  __STATIC_INLINE void EvrNetMEM_ShrinkMemory(uint32_t new_size, uint32_t old_size) {
    EventRecord2 (EvtNetMEM_ShrinkMemory, new_size, old_size);
  }
#else
  #define EvrNetMEM_ShrinkMemory(new_size, old_size)
#endif

/**
  \brief  Event on request to free memory (Op)
 ...
 */
  ...
  __STATIC_INLINE void EvrNetMEM_FreeMemory(uint32_t size, uint32_t used, uint32_t blocks) {
    EventRecord4 (EvtNetMEM_FreeMemory, size, used, blocks, 0);
  }
#else
  #define EvrNetMEM_FreeMemory(size, used, blocks)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetMEM_FreeInvalidBlock(uint32_t size) {
    EventRecord2 (EvtNetMEM_FreeInvalidBlock, size, 0);
  }
#else
  #define EvrNetMEM_FreeInvalidBlock(size)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetMEM_FreeLinkCorrupted(uint32_t size) {
    EventRecord2 (EvtNetMEM_FreeLinkCorrupted, size, 0);
  }
#else
  #define EvrNetMEM_FreeLinkCorrupted(size)
#endif
...
#define EvtNetETH_SendIp6Disabled           EventID (EventLevelError, EvtNetETH, 45) // End
...
#define EvtNetWiFi_SendIp6Disabled           EventID (EventLevelError, EvtNetWiFi, 57) // End
...
#define EvtNetIP4_FragmentationNotEnabled   EventID (EventLevelError, EvtNetIP4, 11)
 ...
 */
  ...
  __STATIC_INLINE void EvrNetIP4_FragmentationNotEnabled(uint16_t if_id) {
    EventRecord2 (EvtNetIP4_FragmentationNotEnabled, if_id, 0);
  }
#else
  #define EvrNetIP4_FragmentationNotEnabled(if_id)
#endif
...
#define EvtNetNBNS_NetBiosDisabled          EventID (EventLevelOp,    EvtNetNBNS, 9) // End
#define EvtNetNBNS_NameQueryRequest         EventID (EventLevelOp,    EvtNetNBNS, 5)
#define EvtNetNBNS_QueryFromAddress         EventID (EventLevelDetail,EvtNetNBNS, 6)
#define EvtNetNBNS_NameQueryResponse        EventID (EventLevelOp,    EvtNetNBNS, 7)
#define EvtNetNBNS_UninitService            EventID (EventLevelOp,    EvtNetNBNS, 8)
#endif
...
#define EvtNetDHCP_ShowMessage              EventID (EventLevelOp,    EvtNetDHCP, 21)
...
#define EvtNetDHCP_ShowRelayAgentAddress    EventID (EventLevelDetail,EvtNetDHCP, 27)
#define EvtNetDHCP_ShowOfferedAddress       EventID (EventLevelOp,    EvtNetDHCP, 28)
...
#define EvtNetDHCP_ShowAssignedAddress      EventID (EventLevelOp,    EvtNetDHCP, 31)
#define EvtNetDHCP_ShowServerId             EventID (EventLevelOp,    EvtNetDHCP, 32)
#define EvtNetDHCP_ShowNetMask              EventID (EventLevelOp,    EvtNetDHCP, 33)
#define EvtNetDHCP_ShowGatewayAddress       EventID (EventLevelOp,    EvtNetDHCP, 34)
#define EvtNetDHCP_ShowDnsServers           EventID (EventLevelOp,    EvtNetDHCP, 35)
#define EvtNetDHCP_ShowLeaseTime            EventID (EventLevelOp,    EvtNetDHCP, 36)
#define EvtNetDHCP_ShowTimeT1               EventID (EventLevelOp,    EvtNetDHCP, 37)
#define EvtNetDHCP_ShowTimeT2               EventID (EventLevelOp,    EvtNetDHCP, 38)
#define EvtNetDHCP_ShowBootfileName         EventID (EventLevelOp,    EvtNetDHCP, 39)
#define EvtNetDHCP_ShowNtpServerList        EventID (EventLevelOp,    EvtNetDHCP, 40)
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowMessage(uint16_t if_id, uint8_t msg_type) {
    EventRecord2 (EvtNetDHCP_ShowMessage, if_id, msg_type);
  }
#else
  #define EvrNetDHCP_ShowMessage(if_id, msg_type)
#endif
...
/**
  \brief  Event on DHCP receive message from invalid Relay Agent (Error)
  \param  if_id         network interface identifier
 */
#ifdef DEBUG_EVR
  __STATIC_INLINE void EvrNetDHCP_RelayAgentAddressInvalid(uint16_t if_id) {
    EventRecord2 (EvtNetDHCP_RelayAgentAddressInvalid, if_id, 0);
  }
#else
  #define EvrNetDHCP_RelayAgentAddressInvalid(if_id)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowRelayAgentAddress(uint16_t if_id, const uint8_t *ip4_addr) {
    memcpy (&evr_buf.u32[0], ip4_addr, 4);
    EventRecord2 (EvtNetDHCP_ShowRelayAgentAddress, if_id, evr_buf.u32[0]);
  }
#else
  #define EvrNetDHCP_ShowRelayAgentAddress(if_id, ip4_addr)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowOfferedAddress(uint16_t if_id, const uint8_t *ip4_addr) {
    memcpy (&evr_buf.u32[0], ip4_addr, 4);
    EventRecord2 (EvtNetDHCP_ShowOfferedAddress, if_id, evr_buf.u32[0]);
  }
#else
  #define EvrNetDHCP_ShowOfferedAddress(if_id, ip4_addr)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowAssignedAddress(uint16_t if_id, const uint8_t *ip4_addr) {
    memcpy (&evr_buf.u32[0], ip4_addr, 4);
    EventRecord2 (EvtNetDHCP_ShowAssignedAddress, if_id, evr_buf.u32[0]);
  }
#else
  #define EvrNetDHCP_ShowAssignedAddress(if_id, ip4_addr)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowServerId(uint16_t if_id, const uint8_t *ip4_addr) {
    memcpy (&evr_buf.u32[0], ip4_addr, 4);
    EventRecord2 (EvtNetDHCP_ShowServerId, if_id, evr_buf.u32[0]);
  }
#else
  #define EvrNetDHCP_ShowServerId(if_id, ip4_addr)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowNetMask(uint16_t if_id, const uint8_t *net_mask) {
    memcpy (&evr_buf.u32[0], net_mask, 4);
    EventRecord2 (EvtNetDHCP_ShowNetMask, if_id, evr_buf.u32[0]);
  }
#else
  #define EvrNetDHCP_ShowNetMask(if_id, net_mask)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowGatewayAddress(uint16_t if_id, const uint8_t *ip4_addr) {
    memcpy (&evr_buf.u32[0], ip4_addr, 4);
    EventRecord2 (EvtNetDHCP_ShowGatewayAddress, if_id, evr_buf.u32[0]);
  }
#else
  #define EvrNetDHCP_ShowGatewayAddress(if_id, ip4_addr)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowDnsServers(uint16_t if_id, const uint8_t *dns_list) {
    ...
    EventRecordData (EvtNetDHCP_ShowDnsServers, &evr_buf, 12);
  }
#else
  #define EvrNetDHCP_ShowDnsServers(if_id, dns_list)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowLeaseTime(uint16_t if_id, uint32_t lease_time) {
    EventRecord2 (EvtNetDHCP_ShowLeaseTime, if_id, lease_time);
  }
#else
  #define EvrNetDHCP_ShowLeaseTime(if_id, lease_time)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowTimeT1(uint16_t if_id, uint32_t t1_time) {
    EventRecord2 (EvtNetDHCP_ShowTimeT1, if_id, t1_time);
  }
#else
  #define EvrNetDHCP_ShowTimeT1(if_id, t1_time)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowTimeT2(uint16_t if_id, uint32_t t2_time) {
    EventRecord2 (EvtNetDHCP_ShowTimeT2, if_id, t2_time);
  }
#else
  #define EvrNetDHCP_ShowTimeT2(if_id, t2_time)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowBootfileName(const uint8_t *bootfile, uint32_t length) {
    ...
    EventRecordData (EvtNetDHCP_ShowBootfileName, bootfile, length);
  }
#else
  #define EvrNetDHCP_ShowBootfileName(bootfile, length)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDHCP_ShowNtpServerList(uint16_t if_id, const uint8_t *ntp_list, uint32_t length) {
    evr_buf.u16[0] = if_id;
    evr_buf.u16[1] = (uint16_t)(length > 12 ? 12 : length);
    memcpy (&evr_buf.u16[2], ntp_list, evr_buf.u16[1]); 
    EventRecordData (EvtNetDHCP_ShowNtpServerList, &evr_buf, evr_buf.u16[1]);
  }
#else
  #define EvrNetDHCP_ShowNtpServerList(if_id, ntp_list, length)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetARP_CacheEntryTimeout(uint16_t if_id, uint32_t entry,
    ...
    evr_buf.u16[0] = if_id;
    evr_buf.u8[2]  = (uint8_t)entry;
    evr_buf.u8[3]  = (uint8_t)type;
    memcpy (&evr_buf.u8[4], ip4_addr, 4);
    memcpy (&evr_buf.u8[8], mac_addr, 6);
...
#define EvtNetBSD_ShowNetAddress            EventID (EventLevelOp,    EvtNetBSD, 11)
// Gap
 ...
 */
  ...
  __STATIC_INLINE void EvrNetBSD_ShowNetAddress(const void *net_addr) {
    const EVR_ADDR *addr = net_addr;
    EventRecordData (EvtNetBSD_ShowNetAddress, addr, addr->type ? 20 : 8);
  }
#else
  #define EvrNetBSD_ShowNetAddress(net_addr)
#endif
...
#define EvtNetHTTPs_ShowRootFolder          EventID (EventLevelOp,    EvtNetHTTPs,  1)
...
#define EvtNetHTTPs_ShowFileStatus          EventID (EventLevelOp,    EvtNetHTTPs, 30)
#define EvtNetHTTPs_ShowRedirectionUrl      EventID (EventLevelOp,    EvtNetHTTPs, 31)
#define EvtNetHTTPs_ShowUserCredentials     EventID (EventLevelOp,    EvtNetHTTPs, 32)
#define EvtNetHTTPs_ShowAcceptLanguage      EventID (EventLevelOp,    EvtNetHTTPs, 33)
#define EvtNetHTTPs_ShowXmlType             EventID (EventLevelOp,    EvtNetHTTPs, 34)
 ...
 */
  ...
  __STATIC_INLINE void EvrNetHTTPs_ShowRootFolder(const char *root_folder, uint32_t length) {
    if (length > 80) length = 80;
    EventRecordData (EvtNetHTTPs_ShowRootFolder, root_folder, length);
  }
#else
  #define EvrNetHTTPs_ShowRootFolder(root_folder, length)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetHTTPs_ShowFileStatus(uint32_t size, uint32_t lm_time) {
    EventRecord2 (EvtNetHTTPs_ShowFileStatus, size, lm_time);
  }
#else
  #define EvrNetHTTPs_ShowFileStatus(size, lm_time)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetHTTPs_ShowRedirectionUrl(const char *url, uint32_t length) {
    if (length > 80) length = 80;
    EventRecordData (EvtNetHTTPs_ShowRedirectionUrl, url, length);
  }
#else
  #define EvrNetHTTPs_ShowRedirectionUrl(url, length)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetHTTPs_ShowUserCredentials(const char *credentials, uint32_t length) {
    ...
    EventRecordData (EvtNetHTTPs_ShowUserCredentials, credentials, length);
  }
#else
  #define EvrNetHTTPs_ShowUserCredentials(credentials, length)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetHTTPs_ShowAcceptLanguage(const char *accept_lang, uint32_t length) {
    ...
    EventRecordData (EvtNetHTTPs_ShowAcceptLanguage, accept_lang, length);
  }
#else
  #define EvrNetHTTPs_ShowAcceptLanguage(accept_lang, length)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetHTTPs_ShowXmlType(const char *xml_type, uint32_t length) {
    ...
    EventRecordData (EvtNetHTTPs_ShowXmlType, xml_type, length);
  }
#else
  #define EvrNetHTTPs_ShowXmlType(xml_type, length)
#endif
...
#define EvtNetDNS_OpcodeOrTruncated         EventID (EventLevelError, EvtNetDNS, 12)
...
/**
  \brief  Event on DNS client OPCODE not zero or message truncated received (Error)
 */
#ifdef DEBUG_EVR
  __STATIC_INLINE void EvrNetDNS_OpcodeOrTruncated(void) {
    EventRecord2 (EvtNetDNS_OpcodeOrTruncated, 0, 0);
  }
#else
  #define EvrNetDNS_OpcodeOrTruncated()
#endif
...
/**
  ...
  \param  used          number of used entries flushed from cache
 ...
 */
  ...
  __STATIC_INLINE void EvrNetDNS_ClearCache(uint32_t used, uint32_t available) {
    EventRecord2 (EvtNetDNS_ClearCache, used, available);
  }
#else
  #define EvrNetDNS_ClearCache(used, available)
#endif
...
#define EvtNetSNMP_ShowCommunity            EventID (EventLevelOp,    EvtNetSNMP,  2)
...
#define EvtNetSNMP_AddObject                EventID (EventLevelDetail,EvtNetSNMP, 15)
...
#define EvtNetSNMP_ShowRequest              EventID (EventLevelOp,    EvtNetSNMP, 22)
 ...
 */
  ...
  __STATIC_INLINE void EvrNetSNMP_ShowCommunity(const char *community, uint32_t length) {
    if (length > 24) length = 24;
    EventRecordData(EvtNetSNMP_ShowCommunity, community, length);
  }
#else
  #define EvrNetSNMP_ShowCommunity(community, length)
#endif
...
/**
  \brief  Event on SNMP add object to SNMP message (Detail)
  \param  obj           object identification number
 ...
 */
  ...
  __STATIC_INLINE void EvrNetSNMP_AddObject(int32_t obj, uint8_t obj_type) {
    EventRecord2 (EvtNetSNMP_AddObject, (uint32_t)obj, obj_type);
  }
#else
  #define EvrNetSNMP_AddObject(obj, obj_type)
#endif
 ...
 */
  ...
  __STATIC_INLINE void EvrNetSNMP_ShowRequest(uint8_t req_type, int32_t req_id) {
    EventRecord2 (EvtNetSNMP_ShowRequest, req_type, (uint32_t)req_id);
  }
#else
  #define EvrNetSNMP_ShowRequest(req_type, req_id)
#endif
