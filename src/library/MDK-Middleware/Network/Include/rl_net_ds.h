...
#define NET_SNMP_MIB_OCTET_STR  0x04    ///< MIB entry type OCTET_STRING
...
///              - BSD_ECONNABORTED    = Connection aborted locally.
///              - BSD_ERROR           = Unspecified error.
extern int connect (int sock, const SOCKADDR *addr, int addrlen);
...
///              - BSD_ENOMEM          = Not enough memory.
///              - BSD_ERROR           = Unspecified error.
extern int sendto (int sock, const char *buf, int len, int flags, const SOCKADDR *to, int tolen);
...
///              - BSD_ENOMEM          = Not enough memory.
///              - BSD_ERROR           = Unspecified error.
extern int sendmsg (int sock, const MSGHDR *msg, int flags);
...
///              - BSD_ECONNABORTED    = Connection aborted locally.
///              - BSD_ERROR           = Unspecified error.
extern int recvmsg (int sock, MSGHDR *msg, int flags);
...
extern int getsockopt (int sock, int level, int optname, char *optval, int *optlen);
...
///              - BSD_EINVAL          = Invalid parameter.
///              - BSD_ENOTSUP         = Option not supported for this socket type.
extern int setsockopt (int sock, int level, int optname, const char *optval, int optlen);
...
///              - 0           = Conversion failed.
extern int inet_aton (const char *cp, IN_ADDR *addr);
...
/// \brief Retrieve path to the root directory of FTP server. [\ref thread-safe]
...
/// \brief Set path to the root directory of FTP server. [\ref thread-safe]
...
/// \brief Open a file for reading or writing in FTP server. [\ref interface]
...
/// \brief Close a file previously open in FTP server. [\ref interface]
/// \param[in]     file          pointer to the file to close.
/// \return        none.
extern void      netFTPs_fclose (void *file);

/// \brief Read block of data from a file in FTP server. [\ref interface]
...
/// \brief Write block of data to a file in FTP server. [\ref interface]
...
/// \brief Delete a file in FTP server. [\ref interface]
...
/// \brief Rename a file or directory in FTP server. [\ref interface]
...
/// \brief Make a new directory in FTP server. [\ref interface]
...
/// \brief Remove an empty directory in FTP server. [\ref interface]
...
/// \brief Retrieve path to the root directory of TFTP server. [\ref thread-safe]
/// \return        pointer to root path, a null-terminated string.
///                - NULL if root folder is disabled in the configuration.
extern const char *netTFTPs_GetRootPath (void);

/// \brief Set path to the root directory of TFTP server. [\ref thread-safe]
/// \param[in]     path          new root path, a null-terminated string.
/// \return      status code that indicates the execution status of the function.
...
/// \brief Open a file for reading or writing in the TFTP server. [\ref interface]
/// \param[in]     fname         name of the file to open.
/// \param[in]     mode          type of access:
///                              - "rb" = opens a file for reading.
///                              - "wb" = opens a file for writing.
...
/// \brief Close a file previously open in the TFTP server. [\ref interface]
/// \param[in]     file          pointer to the file to close.
/// \return        none.
extern void      netTFTPs_fclose (void *file);

/// \brief Read block of data from a file in the TFTP server. [\ref interface]
/// \param[in]     file          pointer to the file to read from.
/// \param[out]    buf           block of memory to write data to.
/// \param[in]     len           length of data to read in bytes.
/// \return        number of bytes successfully read.
...
/// \brief Write block of data to a file in the TFTP server. [\ref interface]
/// \param[in]     file          pointer to the file to write to.
/// \param[in]     buf           block of memory to be written.
/// \param[in]     len           length of data to write in bytes.
/// \return        number of bytes successfully written.
...
/// \brief Retrieve path to the root directory of HTTP server. [\ref thread-safe]
/// \return        pointer to root path, a null-terminated string.
///                - NULL if root folder is disabled in the configuration.
extern const char *netHTTPs_GetRootPath (void);

/// \brief Set path to the root directory of HTTP server. [\ref thread-safe]
/// \param[in]     path          new root path, a null-terminated string.
/// \return      status code that indicates the execution status of the function.
...
/// \brief Open a file for reading in HTTP server. [\ref interface]
/// \param[in]     fname         name of the file to open.
/// \return      status information:
///              - Pointer to an open file.
///              - NULL in case of an error.
...
/// \brief Close a file previously open in HTTP server. [\ref interface]
/// \param[in]     file          pointer to the file to close.
/// \return        none.
extern void      netHTTPs_fclose (void *file);

/// \brief Read block of data from a file in HTTP server. [\ref interface]
/// \param[in]     file          pointer to the file to read from.
/// \param[out]    buf           block of memory to write data to.
/// \param[in]     len           length of data to read in bytes.
/// \return        number of bytes successfully read.
...
/// \brief Read a string from a file in HTTP server. [\ref interface]
/// \param[in]     file          pointer to the file to read from.
...
/// \brief Process query string received by GET request. [\ref user-provided]
