...
#endif
#ifdef DISP_LOG_WARN
#define LOG_WARN(fmt, ...) PRINT_IF("\033[33mWARNING! %s:%d %s()\033[0m: " fmt, __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
#else
#define LOG_WARN(fmt, ...) do{} while (0)
#endif
#ifdef DISP_LOG_ERROR
#define LOG_ERROR(fmt, ...) PRINT_IF("\033[31mERROR!!! %s:%d %s()\033[0m: " fmt, __FILE__, __LINE__, __FUNCTION__, ##__VA_ARGS__)
#else
