...
/* If processor works on high frequency glcd_delay has to be increased, it can be 
...
#define reg_lcd         ((struct lcd_t *) LCD_BASE)
...
{
  return (reg_lcd->dat); /* return value */
}
